#==============================================================================
# ■ Ability_Data
# Pokemon Script Project v1.0 - Nagato Yuki & Palbolsky
# 01/05/2012
#==============================================================================
module PokemonData
  Item=Struct.new(:name,:icon,:descr,:price,:soldable,:socket,:infini,:map_usable,
  :battler_usable,:use_on_pokemon,:holdable,:repel,:effect,:effect_rate,:learn,
  :heal_hp,:heal_pp,:heal_all_pp,:heal_stats,:EV_plus,:EV_amound,:common_event,
  :selectable)
  #repel = repousse
  #===
  ...
  class Item
    ...
    if $DEBUG
      INI=".//Data/Item/%03d.ini"
      CAT="Item"
      ERROR="Erreur lors du chargement du data objet %03d, le membre %s est erronné : %s"
      ...
      Types=[1,1,1,2,4,2,4,4,4,4,4,3,2,2,4,2,2,4,2,2,2,2,4]
      #===
